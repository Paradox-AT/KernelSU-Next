...
{
	return (check_v2_signature(path, expected_manager_size, expected_manager_hash)  // dynamic but honestly this is kind of a meme
	...
	|| check_v2_signature(path,0x033b, "c371061b19d8c7d7d6133c6a9bafe198fa944e50c1b31c9d8daa8d7f1fc2d2d6")  // official ksu but :3
	|| check_v2_signature(path, 0x39b, "593d4ce870c02468639efeef631e07ca4d852d63f154be56706229f9a5be0800")  // wksu (idk who even uses that but cool)
	);
}
